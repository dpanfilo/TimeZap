...
const SEED_EMPLOYEES = [
  ...
  { name: 'Darwin Cordoba',      role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'David Van Engen',     role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Ivan Herrera',        role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'John Ramos',          role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'John Wojcik',         role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  ...
  { name: 'Karen Rodriguez',     role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Karla Lopez',         role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Michelle Juarez-Razo',role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Nara Dugar',          role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Patrick Holzman',     role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Sameer Usman',        role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Samuel Hall',         role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Sona Alhelwani',      role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Victoria Noriega',    role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
  { name: 'Viviana Horta',       role: 'Drafter',        rateType: 'Hourly', rate: '28', hoursPerWeek: '40' },
].map(e => ({ ...e, id: uid() }))
